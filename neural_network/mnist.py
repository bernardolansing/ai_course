...
def get_mnist_network():
    model = keras.Sequential([
        ...
        keras.layers.Dense(256, activation='relu'),  # 1ª camada: 256 neurônios
        keras.layers.Dense(128, activation='relu'),  # 2ª camada: 128 neurônios
        keras.layers.Dense(64, activation='relu'),   # 3ª camada: 64 neurônios
